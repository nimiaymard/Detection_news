...
class TestFeatures(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.input_filepath = os.path.abspath(os.path.join(os.path.dirname(__file__), '../data/raw/sample_test.csv'))
        self.output_filepath = os.path.abspath(os.path.join(os.path.dirname(__file__), '../data/processed/sample_transformed_test.csv'))
